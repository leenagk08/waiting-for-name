...
import { s as commonjsGlobal, t as getDefaultExportFromCjs, r as reactExports, o, w as invariant } from "./index-D1hpymyA.js";
import { P as PropTypes } from "./index-AB_M6uJB.js";
...
var adaptEventsOfChild = function adaptEventsOfChild2(props, data, index) {
  if (!isObject$8(props) || _typeof$E(props) !== "object") {
    return null;
  }
  var out = null;
...
function Surface(props) {
  ...
  return /* @__PURE__ */ o.createElement("svg", _extends$o({}, filterProps(others, true, "svg"), {
...
var Layer = /* @__PURE__ */ o.forwardRef(function(props, ref) {
  ...
  return /* @__PURE__ */ o.createElement("g", _extends$n({
    className: layerClass
...
var Symbols = function Symbols2(_ref) {
  ...
  if (cx === +cx && cy === +cy && size === +size) {
    return /* @__PURE__ */ o.createElement("path", _extends$m({}, filteredProps, {
  ...
  return _createClass$g(DefaultLegendContent2, [{
    ...
    value: function renderItems() {
      ...
      return payload.map(function(entry, i) {
        ...
        return /* @__PURE__ */ o.createElement("li", _extends$l({
          className,
          style: itemStyle,
...
var DefaultTooltipContent = function DefaultTooltipContent2(props) {
  ...
  return /* @__PURE__ */ o.createElement("div", _extends$k({
    className: wrapperCN,
    style: finalStyle
...
var Text = function Text2(_ref5) {
  ...
  return /* @__PURE__ */ o.createElement("text", _extends$j({}, filterProps(textProps, true), {
    x: x2,
    y: y2,
...
function _typeof$s(o2) {
  "@babel/helpers - typeof";
  return _typeof$s = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(o22) {
    return typeof o22;
  } : function(o22) {
...
var formatAxisMap$1 = function formatAxisMap(props, axisMap, offset, axisType, chartName) {
  ...
  return ids.reduce(function(result, id) {
    ...
    return _objectSpread$n(_objectSpread$n({}, result), {}, _defineProperty$o({}, id, finalAxis));
  }, {});
};
...
var renderRadialLabel = function renderRadialLabel2(labelProps, label, attrs) {
  ...
  return /* @__PURE__ */ o.createElement("text", _extends$h({}, attrs, {
...
function Label(_ref4) {
  ...
  return /* @__PURE__ */ o.createElement(Text, _extends$h({
...
var parseLabel = function parseLabel2(label, viewBox) {
  ...
  if (isObject$8(label)) {
    return /* @__PURE__ */ o.createElement(Label, _extends$h({
      viewBox
    }, label, {
      key: "label-implicit"
    }));
...
function LabelList(_ref) {
  ...
  return /* @__PURE__ */ o.createElement(Layer, {
    ...
    return /* @__PURE__ */ o.createElement(Label, _extends$g({}, filterProps(entry, true), others, idProps, {
...
function parseLabelList(label, data) {
  ...
  if (isObject$8(label)) {
    return /* @__PURE__ */ o.createElement(LabelList, _extends$g({
      data
    }, label, {
      key: "labelList-implicit"
    }));
...
function _typeof$j(o2) {
  "@babel/helpers - typeof";
  return _typeof$j = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(o22) {
    return typeof o22;
  } : function(o22) {
    return o22 && "function" == typeof Symbol && o22.constructor === Symbol && o22 !== Symbol.prototype ? "symbol" : typeof o22;
  }, _typeof$j(o2);
...
var mapObject = function mapObject2(fn, obj) {
  return Object.keys(obj).reduce(function(res, key) {
    return _objectSpread$i(_objectSpread$i({}, res), {}, _defineProperty$j({}, key, fn(key, obj[key])));
  }, {});
};
...
const configUpdate = function(from, to, easing, duration, render) {
  ...
  var timingStyle = interKeys.reduce(function(res, key) {
    return _objectSpread$h(_objectSpread$h({}, res), {}, _defineProperty$i({}, key, [from[key], to[key]]));
  }, {});
  var stepperStyle = interKeys.reduce(function(res, key) {
    return _objectSpread$h(_objectSpread$h({}, res), {}, _defineProperty$i({}, key, {
      from: from[key],
      velocity: 0,
      to: to[key]
    }));
...
var Animate = /* @__PURE__ */ function(_PureComponent) {
  ...
  function Animate2(props, context) {
    ...
    if (steps && steps.length) {
      ...
      _this.state = {
        style: attributeName ? _defineProperty$h({}, attributeName, from) : from
      };
    } else {
      _this.state = {
        style: {}
  ...
  _createClass$a(Animate2, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (!isActive) {
        var newState = {
          style: attributeName ? _defineProperty$h({}, attributeName, to) : to
        };
        if (this.state && style) {
    ...
    value: function runAnimation(props) {
      ...
      var to = attributeName ? _defineProperty$h({}, attributeName, propsTo) : propsTo;
...
var Rectangle = function Rectangle2(rectangleProps) {
  ...
  return /* @__PURE__ */ o.createElement(Animate, {
    ...
    }, /* @__PURE__ */ o.createElement("path", _extends$d({}, filterProps(props, true), {
      className: layerClass,
...
var _excluded$6 = ["points", "className", "baseLinePoints", "connectNulls"];
function _extends$c() {
...
var Polygon = function Polygon2(props) {
  var points = props.points, className = props.className, baseLinePoints = props.baseLinePoints, connectNulls = props.connectNulls, others = _objectWithoutProperties$6(props, _excluded$6);
  ...
  if (baseLinePoints && baseLinePoints.length) {
    ...
    return /* @__PURE__ */ o.createElement("g", {
      className: layerClass
    }, /* @__PURE__ */ o.createElement("path", _extends$c({}, filterProps(others, true), {
      fill: rangePath.slice(-1) === "Z" ? others.fill : "none",
      stroke: "none",
      d: rangePath
    })), hasStroke ? /* @__PURE__ */ o.createElement("path", _extends$c({}, filterProps(others, true), {
      fill: "none",
      d: getSinglePolygonPath(points, connectNulls)
    })) : null, hasStroke ? /* @__PURE__ */ o.createElement("path", _extends$c({}, filterProps(others, true), {
      fill: "none",
      d: getSinglePolygonPath(baseLinePoints, connectNulls)
    })) : null);
  }
  var singlePath = getSinglePolygonPath(points, connectNulls);
  return /* @__PURE__ */ o.createElement("path", _extends$c({}, filterProps(others, true), {
...
var Dot = function Dot2(props) {
  ...
  if (cx === +cx && cy === +cy && r === +r) {
    return /* @__PURE__ */ reactExports.createElement("circle", _extends$b({}, filterProps(props, false), adaptEventHandlers(props), {
      className: layerClass,
      cx,
      cy,
      r
...
var Cross = function Cross2(_ref) {
  ...
  return /* @__PURE__ */ o.createElement("path", _extends$a({}, filterProps(props, true), {
...
var _excluded$4 = ["cx", "cy", "angle", "ticks", "axisLine"], _excluded2$1 = ["ticks", "tick", "angle", "tickFormatter", "stroke"];
function _typeof$e(o2) {
  "@babel/helpers - typeof";
  return _typeof$e = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(o3) {
    return typeof o3;
...
var PolarRadiusAxis = /* @__PURE__ */ function(_PureComponent) {
  ...
  return _createClass$9(PolarRadiusAxis2, [{
    ...
    value: function renderAxisLine() {
      var _this$props3 = this.props, cx = _this$props3.cx, cy = _this$props3.cy, angle = _this$props3.angle, ticks2 = _this$props3.ticks, axisLine = _this$props3.axisLine, others = _objectWithoutProperties$4(_this$props3, _excluded$4);
      var extent = ticks2.reduce(function(result, entry) {
        return [Math.min(result[0], entry.coordinate), Math.max(result[1], entry.coordinate)];
      }, [Infinity, -Infinity]);
      var point0 = polarToCartesian(cx, cy, extent[0], angle);
      var point1 = polarToCartesian(cx, cy, extent[1], angle);
      var props = _objectSpread$d(_objectSpread$d(_objectSpread$d({}, filterProps(others, false)), {}, {
        fill: "none"
      ...
      return /* @__PURE__ */ o.createElement("line", _extends$9({
    ...
    value: function renderTicks() {
      var _this = this;
      var _this$props4 = this.props, ticks2 = _this$props4.ticks, tick = _this$props4.tick, angle = _this$props4.angle, tickFormatter = _this$props4.tickFormatter, stroke = _this$props4.stroke, others = _objectWithoutProperties$4(_this$props4, _excluded2$1);
    ...
    value: function renderTickItem(option, props, value) {
      ...
      if (/* @__PURE__ */ o.isValidElement(option)) {
        ...
        tickItem = /* @__PURE__ */ o.createElement(Text, _extends$9({}, props, {
...
_defineProperty$e(PolarRadiusAxis, "displayName", "PolarRadiusAxis");
_defineProperty$e(PolarRadiusAxis, "axisType", "radiusAxis");
_defineProperty$e(PolarRadiusAxis, "defaultProps", {
  type: "number",
  radiusAxisId: 0,
  cx: 0,
  cy: 0,
...
var PolarAngleAxis = /* @__PURE__ */ function(_PureComponent) {
  ...
  return _createClass$8(PolarAngleAxis2, [{
    ...
    value: function renderAxisLine() {
      ...
      var props = _objectSpread$c(_objectSpread$c({}, filterProps(this.props, false)), {}, {
        fill: "none"
      }, filterProps(axisLine, false));
      if (axisLineType === "circle") {
        return /* @__PURE__ */ o.createElement(Dot, _extends$8({
      ...
      return /* @__PURE__ */ o.createElement(Polygon, _extends$8({
        className: "recharts-polar-angle-axis-line"
      }, props, {
        points
      }));
    ...
    value: function renderTicks() {
      ...
      var customTickProps = filterProps(tick, false);
      var tickLineProps = _objectSpread$c(_objectSpread$c({}, axisProps), {}, {
        fill: "none"
      }, filterProps(tickLine, false));
      var items = ticks2.map(function(entry, i) {
        var lineCoord = _this.getTickLineCoord(entry);
        var textAnchor = _this.getTickTextAnchor(entry);
        var tickProps = _objectSpread$c(_objectSpread$c(_objectSpread$c({
          textAnchor
        }, axisProps), {}, {
          stroke: "none",
          fill: stroke
        ...
        return /* @__PURE__ */ o.createElement(Layer, _extends$8({
          ...
          key: "tick-".concat(entry.coordinate)
        }, adaptEventsOfChild(_this.props, entry, i)), tickLine && /* @__PURE__ */ o.createElement("line", _extends$8({
    ...
    value: function renderTickItem(option, props, value) {
      ...
      if (/* @__PURE__ */ o.isValidElement(option)) {
        ...
        tickItem = /* @__PURE__ */ o.createElement(Text, _extends$8({}, props, {
...
_defineProperty$d(PolarAngleAxis, "displayName", "PolarAngleAxis");
_defineProperty$d(PolarAngleAxis, "axisType", "angleAxis");
_defineProperty$d(PolarAngleAxis, "defaultProps", {
  type: "category",
  angleAxisId: 0,
  scale: "auto",
  cx: 0,
...
var Trapezoid = function Trapezoid2(props) {
  ...
  if (!isUpdateAnimationActive) {
    return /* @__PURE__ */ o.createElement("g", null, /* @__PURE__ */ o.createElement("path", _extends$7({}, filterProps(trapezoidProps, true), {
      className: layerClass,
  ...
  return /* @__PURE__ */ o.createElement(Animate, {
    ...
    return /* @__PURE__ */ o.createElement(Animate, {
      ...
      duration: animationDuration,
      easing: animationEasing
    }, /* @__PURE__ */ o.createElement("path", _extends$7({}, filterProps(trapezoidProps, true), {
      className: layerClass,
...
var Brush = /* @__PURE__ */ function(_PureComponent) {
  ...
  return _createClass$7(Brush2, [{
    ...
    value: function renderText() {
      ...
      }, /* @__PURE__ */ o.createElement(Text, _extends$6({
        textAnchor: "end",
        verticalAnchor: "middle",
        x: Math.min(startX, endX) - offset,
        y: y2 + height / 2
      }, attrs), this.getTextOfTick(startIndex)), /* @__PURE__ */ o.createElement(Text, _extends$6({
        textAnchor: "start",
        verticalAnchor: "middle",
...
function BarRectangle(props) {
  return /* @__PURE__ */ o.createElement(Shape, _extends$5({
    shapeType: "rectangle",
  ...
  return _createClass$6(Bar2, [{
    ...
    value: function renderBackground() {
      ...
      return data.map(function(entry, i) {
        ...
        return /* @__PURE__ */ o.createElement(BarRectangle, _extends$4({
...
var renderLine = function renderLine2(option, props) {
  ...
  if (/* @__PURE__ */ o.isValidElement(option)) {
    ...
    line = /* @__PURE__ */ o.createElement("line", _extends$3({}, props, {
...
_defineProperty$4(ReferenceDot, "renderDot", function(option, props) {
  ...
  if (/* @__PURE__ */ o.isValidElement(option)) {
    ...
    dot = /* @__PURE__ */ o.createElement(Dot, _extends$2({}, props, {
      cx: props.cx,
      cy: props.cy,
...
_defineProperty$3(ReferenceArea, "renderRect", function(option, props) {
  ...
  if (/* @__PURE__ */ o.isValidElement(option)) {
    ...
    rect = /* @__PURE__ */ o.createElement(Rectangle, _extends$1({}, props, {
...
export {
  ...
  useChartHeight as I,
  useOffset as J,
  useArbitraryXAxis as K,
  Layer as L,
  useYAxisWithFiniteDomainOrRandom as M,
  getCoordinatesOfGrid as N,
  getTicksOfAxis as O,
  PolarAngleAxis as P,
  Dot as Q,
