import { c as createLucideIcon, r as reactExports, g as useActiveQrSession, m as useSessionAttendance, n as useCreateQrSession, j as jsxRuntimeExports, B as BookOpen, Q as QrCode } from "./index-D1hpymyA.js";
import { p as propTypesExports } from "./index-AB_M6uJB.js";
...
function TeacherQrPage() {
  ...
  async function handleCreate() {
    if (!courseName.trim()) {
      ue.error("Please enter a course name.");
      return;
    }
    try {
      await createSession.mutateAsync(courseName.trim());
      ue.success("QR session created!");
      setCourseName("");
    } catch {
      ue.error("Failed to create QR session.");
    }
  }
  const qrValue = session ? JSON.stringify({ sessionId: session.sessionId, token: session.token }) : "";
  const expiresAt = session ? new Date(Number(session.expiresAt) / 1e6) : null;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 animate-fade-in max-w-2xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold font-display", children: "QR Attendance" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mt-1", children: "Generate a rotating QR code for attendance" })
    ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              createSession.isPending ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-4 w-4 animate-spin rounded-full border-2 border-white/30 border-t-white" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(QrCode, { className: "h-4 w-4" }),
              "Create"
            ]
          }
        )
    ...
    isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 self-start w-full", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-2 w-2 rounded-full bg-emerald-500 animate-pulse" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium text-emerald-400", children: "Active Session" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-2xl p-4 bg-white shadow-xl", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              _default,
              {
                value: qrValue,
                size: 200,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute -bottom-4 -right-4 h-13 w-13 glass rounded-full flex flex-col items-center justify-center shadow-lg border border-border/40 px-2 py-1.5 min-w-[3.25rem]", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground leading-none", children: "Next" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 text-xs text-muted-foreground pt-2", children: [
            ...
            expiresAt && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCw, { className: "h-3 w-3" }),
              "Expires: ",
              expiresAt.toLocaleTimeString()
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full rounded-xl bg-muted/40 p-3 space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Session ID" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-xs break-all", children: session.sessionId })
          ] })
        ]
      }
    ) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "qr.empty_state", className: "glass-card p-10 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(QrCode, { className: "h-14 w-14 text-muted-foreground/30 mx-auto mb-4" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold mb-1", children: "No Active Session" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Create a session above to generate the QR code." })
    ] })
  ] });
}
export {
  TeacherQrPage as default
};
